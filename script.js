...
function initChart() {
    ...
    chart = new Chart(ctx, {
        ...
        data: {
            labels: [],
            datasets: [
                { label: '原始信号', data: [], borderColor: '#ff4d94', borderWidth: 2, pointRadius: 0, tension: 0.2 },
                { label: '滤波后', data: [], borderColor: '#00e0ff', borderWidth: 2, pointRadius: 0, tension: 0.2 }
            ]
        },
        options: {
            responsive: true,
            maintainAspectRatio: false,
            plugins: { legend: { labels: { color: '#cdd9ed' } } },
            scales: {
